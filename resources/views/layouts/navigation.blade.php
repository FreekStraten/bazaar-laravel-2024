            ...
            <div class="flex items-center gap-6">
                ...
                <div class="hidden sm:flex items-center gap-2">
                    ...
                    <div class="relative">
                        ...
                        <div class="hidden absolute mt-2 w-40 rounded-lg border border-slate-200 bg-white shadow-xl p-1">
            ...
            <div class="flex items-center gap-2">
                @auth
                    <div class="relative">
                        ...
                        <div class="hidden absolute right-0 mt-2 w-48 rounded-lg border border-slate-200 bg-white shadow-xl p-1">
